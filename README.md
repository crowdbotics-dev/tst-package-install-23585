...
## Project Structure
    ...
    ├── tst_package_install_23585  # Django project configurations
...
1. Clone this repo and `cd tst_package_install_23585`
...
2. Clone this repo and `cd tst_package_install_23585`
